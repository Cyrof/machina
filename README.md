...
# Specific OU
.\machina join --domain "your-domain.com" --prompt --out "OU=Clients,OU=Workstations,DC=you-domain,DC=com"
```
...
- `--ou`: Specify an **Organisational Unit (OU)** to place the computer object into.
    > The OU must exist and be accessible by the joining account.
...
```json
{
    "LogDirs": ["C:\\Machina\\Logs", "C:\\Windows\\Panter"],
    "TempFiles": ["C:\\Windows\\Temp\\*", "C:\\Users\\Public\\*.bak"],
    "RegKeys": ["HKLM:\\Software\\Machina", "HKCU:\\Software\\Machina"],
    "Services": ["MachinaAgentTmp", "SetupDiag"],
    "ExtraPaths": [
