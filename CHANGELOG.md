...
- `--ou` flag for the `join` command, allowing the machine to be joined to a specific Organisation Unit (OU) in Active Directory.

### Fixed

- Minor internal improvement to the `--dns` flag handling during domain join.
